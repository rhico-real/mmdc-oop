...
public class ViewPayslipPage extends javax.swing.JFrame {
    ...
    public ViewPayslipPage(String employeeNo, String employeeName, String address, String immediateSupervisor,
                           String sssNo, String philHealthNo, String phoneNum, String position,
                           String tinNo, String pagIbigNo, String hourlyRate,
                           String daysWorked, String overtime, String riceAllowance, String phoneAllowance,
                           String clothingAllowance, String sssDeduction, String philHealthDeduction,
                           String pagIbigDeduction, String withholdingTax, String totalDeductions,
                           String grossIncome, String netPay) {
    ...
    private void initComponents() {
        ...
        lblHourlyRate.setFont(new java.awt.Font("Segoe UI", 1, 12)); 
                                ...
                                .addGroup(gl_contentPane.createSequentialGroup()
                                    .addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
                                        .addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING, false)
                                            ...
                                            .addComponent(lblHourlyRate, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
     ...
     // Inside the initComponents() method, after initializing lblTitle
...
//        );
        ...
        gl_titlePane.setHorizontalGroup(
        	    gl_titlePane.createSequentialGroup()
        	        .addGap(15, 15, 15)
        	        .addComponent(lblTitle, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE)
        	        .addPreferredGap(ComponentPlacement.RELATED, 300, Short.MAX_VALUE) // Adjust as needed
        	        .addComponent(btnBack) // Add the Back button here
        	        .addContainerGap()
        	);
        	gl_titlePane.setVerticalGroup(
        	    gl_titlePane.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        	    .addGroup(gl_titlePane.createSequentialGroup()
        	        .addContainerGap()
        	        .addGroup(gl_titlePane.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        	            .addComponent(lblTitle, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
        	            .addComponent(btnBack)) // Ensure the Back button is included here
        	        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        	);
    ...
    private void populateFields() {
        ...
        txtSupervisor.setText(immediateSupervisor);
        txtSSSNum.setText(sssNo);
        txtPhilHealthNum.setText(philHealthNo);
        txtPhoneNum.setText(phoneNum);
        txtPosition.setText(position);
        txtTinNo.setText(tinNo);
        txtPagibigNum.setText(pagIbigNo);
        txtHourlyRate.setText(hourlyRate);
        txtDaysWorked.setText(daysWorked);
        txtOvertime.setText(overtime);
        txtRiceAllowance.setText(riceAllowance);
        txtPhoneAllowance.setText(phoneAllowance);
        txtClothingAllowance.setText(clothingAllowance);
        txtSSS.setText(sssDeduction);
        txtPhilHealth.setText(philHealthDeduction);
        txtPagIbig.setText(pagIbigDeduction);
        txtWithHoldingTax.setText(withholdingTax);
        txtTotalDeductions.setText(totalDeductions);
        txtGrossIncome.setText(grossIncome);
    ...
    public static void main(String args[]) {
    	        ...
    	        java.awt.EventQueue.invokeLater(new Runnable() {
    	            public void run() {
    	                new ViewPayslipPage(
    	                    "E123", // Example employee number
    	                    "John Doe", // Example employee name
    	                    "123 Main St", // Example address
    	                    "Jane Smith", // Example immediate supervisor
    	                    "SSS123456", // Example SSS number
    	                    "PH123456", // Example PhilHealth number
    	                    "09123456789", // Example phone number
    	                    "Software Engineer", // Example position
    	                    "TIN123456", // Example TIN number
    	                    "PAGIBIG123456", // Example Pag-Ibig number
    	                    "0", // Example hourly rate
    	                    "22", // Example days worked
    	                    "5", // Example overtime
    	                    "2000", // Example rice subsidy
    	                    "1500", // Example phone allowance
    	                    "1000", // Example clothing allowance
    	                    "3000", // Example SSS deduction
    	                    "1000", // Example PhilHealth deduction
    	                    "500", // Example Pag-Ibig deduction
    	                    "2000", // Example withholding tax
    	                    "10000", // Example total deductions
    	                    "40000", // Example gross income
    	                    "30000" // Example net pay
    	                ).setVisible(true);
    	            }
    	        });
    	    }
